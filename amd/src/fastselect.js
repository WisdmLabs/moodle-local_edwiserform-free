...
(function(root, factory) {
    ...
    Fastselect.defaults = {
        ...
        placeholder: M.util.get_string('lbl-event-choose', 'local_edwiserform'),
        searchPlaceholder: M.util.get_string('lbl-event-search', 'local_edwiserform'),
        noResultsText: M.util.get_string('lbl-event-search-not-found', 'local_edwiserform'),
