...
$string['efb-heading-listforms']="View All Form";
...
$string['efb-lbl-form-setup']="Form Templates";
$string['efb-lbl-form-settings']="Setting";
...
$string["profeature"] = '{$a} is a PRO feature. To use {$a} please upgrade to Edwiserform PRO.';
