...
$string['efb-genral-settings']="Genral Settings";
...
$string['efb-lbl-form-builder']="Builder";
...
$string['efb-lbl-notifi-email']="Notification Email";
...
$string['efb-event-login-desc'] = 'Provides the login form.';
$string['efb-event-registration-name'] = "User Registration Form";
$string['efb-event-registration-desc'] = "Provides the registration form.";
...
$string['efb-setup-msg-upgrade']="Unlock Pre-Made Form Templates";
...
$string["efb-tbl-heading-author"]="Form Author";
$string["efb-tbl-heading-created"]="Created On";
$string["efb-tbl-heading-modified"]="Modified On";
...
$string["efb-form-action-disable-title"] = "Disable disable form";
$string["efb-form-setting-save-msg"]="Form saved successfuly.";
...
$string["efb-form-data-no-data"] = "Nothing to display";
...
$string["advanceFields"] = "Advance Fields(PRO)";
$string["standardFields"] = "Standard Fields(PRO)";
...
$string["cannotremove"] = "Cannot remove {{type}}. Contains template elements:<br>";
...
$string["hide"] = "Edit";
$string["htmlElements"] = "HTML Elements(PRO)";
$string["info"] = "Info";
...
$string["profeature"] = '{$a} is a PRO feature. To use this please upgrade to Edwiserform PRO.';
$string["row.settings.inputGroup.aria"] = "Aria";
$string["radio"] = "Radio";
$string["radioGroup"] = "Radio Group";
