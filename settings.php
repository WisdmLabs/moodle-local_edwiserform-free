...
// Add admin menues
$ADMIN->add('modules', new admin_category('edwiserform', new lang_string("efb-plugin-name", "local_edwiserform")));
...
$ADMIN->add('edwiserform', new admin_externalpage('efbimportform', new lang_string("efb-heading-import", "local_edwiserform"), "$CFG->wwwroot/local/edwiserform/view.php?page=import"));
...
// General settings
$settings = new admin_settingpage('local_edwiserform', new lang_string('efb-plugin-name', 'local_edwiserform'));
